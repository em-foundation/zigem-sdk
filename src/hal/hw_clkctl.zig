...
pub const CLKCTL_DESC_MODID_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xFFFF0000, .hexadecimal);
...
pub const CLKCTL_DESCEX0_LGPT3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT3_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT3_S = @as(c_uint, 30);
pub const CLKCTL_DESCEX0_LGPT3_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT3_IP_UNAVAIL = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX0_LGPT2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT2_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT2_S = @as(c_uint, 29);
pub const CLKCTL_DESCEX0_LGPT2_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT2_IP_UNAVAIL = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX0_LGPT1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT1_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT1_S = @as(c_uint, 28);
pub const CLKCTL_DESCEX0_LGPT1_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT1_IP_UNAVAIL = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX0_LGPT0 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT0_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT0_S = @as(c_uint, 27);
pub const CLKCTL_DESCEX0_LGPT0_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_DESCEX0_LGPT0_IP_UNAVAIL = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX0_DMA = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_DESCEX0_DMA_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_DESCEX0_DMA_S = @as(c_uint, 17);
pub const CLKCTL_DESCEX0_DMA_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_DESCEX0_DMA_IP_UNAVAIL = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX0_LAES = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_DESCEX0_LAES_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_DESCEX0_LAES_S = @as(c_uint, 16);
pub const CLKCTL_DESCEX0_LAES_IP_AVAIL = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
...
pub const CLKCTL_DESCEX1_FLASHSZ_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xC0000000, .hexadecimal);
pub const CLKCTL_DESCEX1_FLASHSZ_S = @as(c_uint, 30);
pub const CLKCTL_DESCEX1_FLASHSZ_SZ3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xC0000000, .hexadecimal);
pub const CLKCTL_DESCEX1_FLASHSZ_SZ2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x80000000, .hexadecimal);
pub const CLKCTL_DESCEX1_FLASHSZ_SZ1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_DESCEX1_FLASHSZ_SZ0 = @as(c_uint, 0x00000000);
pub const CLKCTL_DESCEX1_SRAMSZ_W = @as(c_uint, 2);
pub const CLKCTL_DESCEX1_SRAMSZ_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x30000000, .hexadecimal);
pub const CLKCTL_DESCEX1_SRAMSZ_S = @as(c_uint, 28);
pub const CLKCTL_DESCEX1_SRAMSZ_SZ3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x30000000, .hexadecimal);
pub const CLKCTL_DESCEX1_SRAMSZ_SZ2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_DESCEX1_SRAMSZ_SZ1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
...
pub const CLKCTL_CLKCFG0_LGPT3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT3_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT3_S = @as(c_uint, 30);
pub const CLKCTL_CLKCFG0_LGPT3_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT3_CLK_DIS = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKCFG0_LGPT2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT2_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT2_S = @as(c_uint, 29);
pub const CLKCTL_CLKCFG0_LGPT2_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT2_CLK_DIS = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKCFG0_LGPT1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT1_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT1_S = @as(c_uint, 28);
pub const CLKCTL_CLKCFG0_LGPT1_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT1_CLK_DIS = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKCFG0_LGPT0 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT0_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT0_S = @as(c_uint, 27);
pub const CLKCTL_CLKCFG0_LGPT0_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LGPT0_CLK_DIS = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKCFG0_DMA = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKCFG0_DMA_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKCFG0_DMA_S = @as(c_uint, 17);
pub const CLKCTL_CLKCFG0_DMA_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKCFG0_DMA_CLK_DIS = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKCFG0_LAES = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LAES_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKCFG0_LAES_S = @as(c_uint, 16);
pub const CLKCTL_CLKCFG0_LAES_CLK_EN = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
...
pub const CLKCTL_CLKENSET0_LGPT3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT3_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT3_S = @as(c_uint, 30);
pub const CLKCTL_CLKENSET0_LGPT3_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT3_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENSET0_LGPT2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT2_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT2_S = @as(c_uint, 29);
pub const CLKCTL_CLKENSET0_LGPT2_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT2_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENSET0_LGPT1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT1_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT1_S = @as(c_uint, 28);
pub const CLKCTL_CLKENSET0_LGPT1_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT1_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENSET0_LGPT0 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT0_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT0_S = @as(c_uint, 27);
pub const CLKCTL_CLKENSET0_LGPT0_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LGPT0_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENSET0_DMA = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENSET0_DMA_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENSET0_DMA_S = @as(c_uint, 17);
pub const CLKCTL_CLKENSET0_DMA_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENSET0_DMA_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENSET0_LAES = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LAES_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKENSET0_LAES_S = @as(c_uint, 16);
pub const CLKCTL_CLKENSET0_LAES_CLK_SET = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
...
pub const CLKCTL_CLKENCLR0_LGPT3 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT3_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT3_S = @as(c_uint, 30);
pub const CLKCTL_CLKENCLR0_LGPT3_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x40000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT3_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENCLR0_LGPT2 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT2_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT2_S = @as(c_uint, 29);
pub const CLKCTL_CLKENCLR0_LGPT2_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x20000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT2_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENCLR0_LGPT1 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT1_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT1_S = @as(c_uint, 28);
pub const CLKCTL_CLKENCLR0_LGPT1_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT1_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENCLR0_LGPT0 = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT0_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT0_S = @as(c_uint, 27);
pub const CLKCTL_CLKENCLR0_LGPT0_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x08000000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LGPT0_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENCLR0_DMA = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_DMA_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_DMA_S = @as(c_uint, 17);
pub const CLKCTL_CLKENCLR0_DMA_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00020000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_DMA_CLK_UNCHGD = @as(c_uint, 0x00000000);
pub const CLKCTL_CLKENCLR0_LAES = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LAES_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
pub const CLKCTL_CLKENCLR0_LAES_S = @as(c_uint, 16);
pub const CLKCTL_CLKENCLR0_LAES_CLK_CLR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00010000, .hexadecimal);
...
pub const CLKCTL_STBYPTR_VAL_M = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xFFFFFFFF, .hexadecimal);
