...
pub const NVIC_BASE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xE000E000, .hex);
pub const SYSTICK_BASE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xE000E010, .hex);
pub const SCB_BASE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xE000ED00, .hex);
