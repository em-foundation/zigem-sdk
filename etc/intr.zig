...
pub const intfunc = ?*const fn () callconv(.C) void;
pub const intvec_elem = extern union {
    fxn: intfunc,
    ptr: ?*anyopaque,
};
pub extern var __stack_top__: c_int;
pub extern fn __em_program_start() void;
pub export const __vector_table: [16]intvec_elem linksection(".intvec") = [16]intvec_elem{
    intvec_elem{
        .ptr = @as(?*anyopaque, @ptrCast(&__stack_top__)),
    },
    intvec_elem{
