...
pub inline fn __cmsis_start() noreturn {
    const struct_unnamed_1 = extern struct {
        src: [*c]const u32 = @import("std").mem.zeroes([*c]const u32),
        dest: [*c]u32 = @import("std").mem.zeroes([*c]u32),
        wlen: u32 = @import("std").mem.zeroes(u32),
    };
    _ = &struct_unnamed_1;
    const __copy_table_t = struct_unnamed_1;
    _ = &__copy_table_t;
    ...
    _ = &struct_unnamed_2;
    const __zero_table_t = struct_unnamed_2;
    _ = &__zero_table_t;
    {
        var pTable: [*c]const __copy_table_t = &__copy_table_start__;
        _ = &pTable;
        while (pTable < (&__copy_table_end__)) : (pTable += 1) {
            {
                var i: u32 = 0;
                _ = &i;
                while (i < pTable.*.wlen) : (i +%= 1) {
    ...
    {
        var pTable: [*c]const __zero_table_t = &__zero_table_start__;
        _ = &pTable;
        while (pTable < (&__zero_table_end__)) : (pTable += 1) {
            {
                var i: u32 = 0;
                _ = &i;
                while (i < pTable.*.wlen) : (i +%= 1) {
    ...
    _start();
} // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:196:27: warning: unable to translate function, demoted to extern
pub extern fn __enable_irq() void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:207:27: warning: unable to translate function, demoted to extern
pub extern fn __disable_irq() void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:218:31: warning: unable to translate function, demoted to extern
pub extern fn __get_CONTROL() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:248:27: warning: unable to translate function, demoted to extern
pub extern fn __set_CONTROL(arg_control: u32) void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:272:31: warning: unable to translate function, demoted to extern
pub extern fn __get_IPSR() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:286:31: warning: unable to translate function, demoted to extern
pub extern fn __get_APSR() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:300:31: warning: unable to translate function, demoted to extern
pub extern fn __get_xPSR() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:314:31: warning: unable to translate function, demoted to extern
pub extern fn __get_PSP() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:344:27: warning: unable to translate function, demoted to extern
pub extern fn __set_PSP(arg_topOfProcStack: u32) void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:368:31: warning: unable to translate function, demoted to extern
pub extern fn __get_MSP() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:398:27: warning: unable to translate function, demoted to extern
pub extern fn __set_MSP(arg_topOfMainStack: u32) void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:449:31: warning: unable to translate function, demoted to extern
pub extern fn __get_PRIMASK() u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:479:27: warning: unable to translate function, demoted to extern
...
// ./cmsis_gcc.h:933:27: warning: unable to translate function, demoted to extern
pub extern fn __ISB() void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:944:27: warning: unable to translate function, demoted to extern
pub extern fn __DSB() void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:955:27: warning: unable to translate function, demoted to extern
pub extern fn __DMB() void; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:967:31: warning: unable to translate function, demoted to extern
pub extern fn __REV(arg_value: u32) u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:986:31: warning: unable to translate function, demoted to extern
pub extern fn __REV16(arg_value: u32) u32; // ./cmsis_gcc.h:41:50: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./cmsis_gcc.h:1001:30: warning: unable to translate function, demoted to extern
pub extern fn __REVSH(arg_value: i16) i16;
...
pub const __ASM = @compileError("unable to translate C expr: unexpected token '__asm'"); // ./cmsis_gcc.h:41:11
pub const __INLINE = @compileError("unable to translate C expr: unexpected token 'inline'"); // ./cmsis_gcc.h:44:11
pub const __STATIC_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // ./cmsis_gcc.h:47:11
pub const __STATIC_FORCEINLINE = @compileError("unable to translate macro: undefined identifier `always_inline`"); // ./cmsis_gcc.h:50:11
pub const __NO_RETURN = @compileError("unable to translate macro: undefined identifier `__noreturn__`"); // ./cmsis_gcc.h:53:11
pub const __USED = @compileError("unable to translate macro: undefined identifier `used`"); // ./cmsis_gcc.h:56:11
pub const __WEAK = @compileError("unable to translate macro: undefined identifier `weak`"); // ./cmsis_gcc.h:59:11
pub const __PACKED = @compileError("unable to translate macro: undefined identifier `packed`"); // ./cmsis_gcc.h:62:11
pub const __PACKED_STRUCT = @compileError("unable to translate macro: undefined identifier `packed`"); // ./cmsis_gcc.h:65:11
pub const __PACKED_UNION = @compileError("unable to translate macro: undefined identifier `packed`"); // ./cmsis_gcc.h:68:11
pub const __UNALIGNED_UINT16_WRITE = @compileError("unable to translate C expr: expected ')' instead got '='"); // ./cmsis_gcc.h:84:11
pub const __UNALIGNED_UINT16_READ = @compileError("unable to translate C expr: unexpected token 'const'"); // ./cmsis_gcc.h:92:11
pub const __UNALIGNED_UINT32_WRITE = @compileError("unable to translate C expr: expected ')' instead got '='"); // ./cmsis_gcc.h:100:11
pub const __UNALIGNED_UINT32_READ = @compileError("unable to translate C expr: unexpected token 'const'"); // ./cmsis_gcc.h:108:11
pub const __ALIGNED = @compileError("unable to translate macro: undefined identifier `aligned`"); // ./cmsis_gcc.h:111:11
pub const __RESTRICT = @compileError("unable to translate C expr: unexpected token '__restrict'"); // ./cmsis_gcc.h:114:11
pub const __COMPILER_BARRIER = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:117:11
pub const __INITIAL_SP = @compileError("unable to translate macro: undefined identifier `__StackTop`"); // ./cmsis_gcc.h:170:9
pub const __STACK_LIMIT = @compileError("unable to translate macro: undefined identifier `__StackLimit`"); // ./cmsis_gcc.h:174:9
pub const __VECTOR_TABLE = @compileError("unable to translate macro: undefined identifier `__Vectors`"); // ./cmsis_gcc.h:178:9
pub const __VECTOR_TABLE_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `used`"); // ./cmsis_gcc.h:182:9
pub const __NOP = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:903:9
pub const __WFI = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:909:9
pub const __WFE = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:917:9
pub const __SEV = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:924:9
pub const __BKPT = @compileError("unable to translate C expr: unexpected token 'volatile'"); // ./cmsis_gcc.h:1039:9
