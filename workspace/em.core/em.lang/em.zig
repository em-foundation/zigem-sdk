...
pub const UnitName = @import("../../zigem/gen/unit_names.zig").UnitName;
...
const targ = @import("../../zigem/gen/targ.zig");
...
const props = @import("../../zigem/gen/props.zig");
...
pub const import = @import("../../zigem/gen/imports.zig");
